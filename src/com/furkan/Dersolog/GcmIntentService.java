...
public class GcmIntentService extends IntentService {
        ...
        if (!extras.isEmpty()) {  // has effect of unparcelling Bundle
            ...
            if (GoogleCloudMessaging.
                ...
                sendNotification("Deleted messages on server: " +
                    ...
                    MESSAGE_TYPE_MESSAGE.equals(messageType)) {//Herhangi bir sorun yoksa Notification mýzý oluþturacak methodu çaðýrýyoruz
    ...
    private void sendNotification(String msg) { //Burda Status barda gösterilecek Notificationýn ayarlarý yapýlýyor(titreþim,bildirim,text boyutu vs..)
